        ...
        <div className="w-[93%] m-auto py-3">
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-4 justify-center items-center relative">
              ...
              <div
                className={`absolute top-[60px] right-0 w-[250px] bg-[#313030] p-3 border border-gray-700 transition duration-500 ${show ? "visible opacity-100" : "invisible opacity-30"} `}
              >
